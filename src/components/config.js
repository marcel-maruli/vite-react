const config = {
  ...
  */
  ...
  // 🔐 Passcode Page
  correctPasscode: "1101", // Change this to any 4-digit code (the passcode for access)
  ...
  // ⏳ Timer Page
  anniversaryDate: "2024-11-01", // 📅 Set your anniversary date here (used for the timer)
  ...
  // 🎵 Music Page
  musicTitle: "Songs that describe us", // Title for the music page
  musicGallery: [
    {
    ...
    {
      title: "L", // Title of the song
      artist: "Hal", // Artist of the song
      left: "5%", // Positioning on the page
      top: "5%", // Positioning on the page
    },
    {
      title: "Pendengar Setiamu",
      artist: "Hal",
      left: "40%",
      top: "15%",
    },
    ...
    messageGallery: [
      { title: "Everyday", description: "Makan Makan Makan" }, // Message entry
      { title: "Everyday", description: "Full of love ❤️" }, // Message entry
      { title: "Everyday", description: "Happy Happy Happy" }, // Message entry
    ],
  
    // 📸 Picture Recap Page
    pictureTitle: "Our memories", // Title for the pictures recap page
    pictureGallery: [
      { title: "December 30, 2024", description: "Visitting Bude Ninong" }, // Picture entry
      { title: "January 4, 2025", description: "Prep for your new company💼" },
      { title: "January 8, 2025", description: "Rurie's wedding 💒" },
      { title: "Januari 20, 2025", description: "Your first day at work!" },
    ],
  

  // 💌 Love Letter Page
  loveLetterMessage: "Hi, sorry for the late Valentine's Day greetings. I'm so grateful to have you back in my life. After reading your Valentine's letter, I felt so appreciated by you. Thanks for always try to show how much you love me. I love you so much 💖", // Message displayed on the love letter page
